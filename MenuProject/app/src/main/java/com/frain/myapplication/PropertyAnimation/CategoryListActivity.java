...
public class CategoryListActivity extends ListActivity {
    private List<String> mData = new ArrayList<String>(Arrays.asList(
            ...
            "View的anim方法", "Layout Anim", "ValueAnimator创建动画","VlaueAnimator Demo","TouchAnimationActivity"));
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            ...
            case 5:
                ...
                break;
            case 6:
                intent = new Intent(this, ValueAnimatorTwoActivity.class);
                break;
            case 7:
                intent=new Intent(this,TouchAnimationActivity.class);
                break;
        }
